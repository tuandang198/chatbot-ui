...
export function Chat() {
  ...
  const sendMessage = async (message: string) => {
    ...
    //   lastMessage = lastMessage + chunkValue
      ...
      setMessages([
        ...newMessages,
        { role: 'assistant', content: "lastM essa gekkkk kkkk kkkk kkk kkkk kkkkkk kkkkk kkk kkkkk kkkkk kkkkk kkkkkkd dddddd dddddd dddddddd dddddd dddd dddd" } as ChatGPTMessage,
      ]) 
